...
- [Use case diagram and use cases](#use-case-diagram-and-use-cases)
  ...
  - [Use Cases](#use-cases)
    - [Use case 1, UC1 - Update price of a gas station](#use-case-1-uc1---update-price-of-a-gas-station)
...
### Use case 1, UC1 - Update price of a gas station
...
|  Post condition     | Price update request X of Y type of fuel at Z station is removed |
| Step#        | Description  |
|  1     | User selects the modification request |  
|  2     | User removes the request |
