...
public class GasStationServiceimpl implements GasStationService {
	GasStationRepository gasStationepository;
	@Override
	public GasStationDto getGasStationById(Integer gasStationId) throws InvalidGasStationException {
		...
		GasStation gasStation = gasStationepository.findOne(gasStationId);
		if( gasStation == null ) {
			return null;
		} 	
	...
	public GasStationDto saveGasStation(GasStationDto gasStationDto) throws PriceException, GPSDataException {
		...
		GasStation gasStation = gasStationepository.save(GasStationConverter.toGasStation(gasStationDto));
		return GasStationConverter.toGasStationDto(gasStation);
	}
	...
	public List<GasStationDto> getAllGasStations() {
		...
		List<GasStation> gasStations = gasStationepository.findAll();
		if( gasStations == null ) {
			return null;
		}
	...
	public Boolean deleteGasStation(Integer gasStationId) throws InvalidGasStationException {
		...
		if(!gasStationepository.exists(gasStationId))
			return false;
		gasStationepository.delete(gasStationId);
		if(gasStationepository.exists(gasStationId))
			return false;
		return true;
	}
	...
	public void setReport(Integer gasStationId, double dieselPrice, double superPrice, double superPlusPrice,
		...
		gasStationepository.save(GasStationConverter.toGasStation(gasStationDto));
